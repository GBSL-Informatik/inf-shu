...
![--width=350](resources/Turtlegrafik-eckige-Spirale.png)
...
:::aufgabe[Aufgabe 6: Farbige Blume]
<Answer type="state" id="ff97747c-9cfd-423c-8a91-e00b51994e7a" />

   1. Schreibe ein Programm, welches mit einer for-Schleife und dem Befehl `color`
   die folgende farbige Turtlegrafik generiert:

![](resources/Turtlegrafik-Colored-Circles.png)

   2. Ändere die Reihenfolge der Farben so ab, dass sich rot und blau abwechseln.

<Solution id="c6613b77-08c3-459b-a6e7-cdf66ecd075e">

```py live_py slim title=farbige_blume_1.py id=ebd5a5f0-2f61-4471-82d5-270cfd2fff02
from turtle import *
for farbe in ["red", "violet", "blue", "cyan", "green", "orange"]:
    color(dicke)
    circle(100)
    left(60)
```

```py live_py slim title=farbige_blume_2.py id=75c8d58a-6595-41d9-a738-a3c4135c6348
from turtle import *
for farbe in ["red", "blue", "red", "blue", "red", "blue"]:
    color(dicke)
    circle(100)
    left(60)
```
